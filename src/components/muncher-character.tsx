  ...
  return (
    <div className="w-full h-full flex items-center justify-center">
      <div className="w-4/5 h-4/5 bg-green-500 relative">
        ...
        {/* Mouth */}
        <div className="absolute bottom-1/4 left-1/4 w-1/2 h-1/5 bg-black"></div>

        {/* Legs */}
        <div className="absolute bottom-0 left-1/4 w-1/6 h-1/4 bg-green-500"></div>
        <div className="absolute bottom-0 right-1/4 w-1/6 h-1/4 bg-green-500"></div>
      </div>
    </div>
  )
}
